...
encoding utf-8
Sheet 1 1
Title "PMOD - Wifi module (ESP82xx)"
Date "2019-02-21"
Rev "0.1"
Comp "Agilack"
Comment1 ""
...
F 1 "CONN_3" V 4850 7000 40  0000 C CNN
F 2 "pmod-wifi:CONN_3" H 4850 7000 60  0001 C CNN
...
U 1 1 5BC4AD37
P 5200 7200
F 0 "#PWR023" H 5200 7200 30  0001 C CNN
...
F 3 "" H 5200 7200 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 5200 7000 2    45   Input ~ 0
UART_TX
Text GLabel 5200 6900 2    45   Output ~ 0
UART_RX
...
U 1 1 5BC4BCC3
P 5100 5300
F 0 "U2" H 5250 5700 60  0000 C CNN
F 1 "M25P16-VME" H 5450 4900 60  0000 C CNN
F 2 "pmod-wifi:SOIC-8E" H 5100 5300 60  0001 C CNN
...
U 1 1 5BC4BE8E
P 5100 4800
F 0 "#PWR024" H 5100 4760 30  0001 C CNN
...
U 1 1 5BC4C087
P 5100 5800
F 0 "#PWR025" H 5100 5800 30  0001 C CNN
...
F 3 "" H 5100 5800 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 4500 5450 0    45   Input ~ 0
MEM_CLK
Text GLabel 5850 2950 2    45   Output ~ 0
MEM_CLK
Text GLabel 5850 3050 2    45   Output ~ 0
MEM_CS
Text GLabel 4500 5150 0    45   Input ~ 0
MEM_CS
Text GLabel 5850 3350 2    45   Output ~ 0
MEM_HOLD
Text GLabel 5850 3450 2    45   Output ~ 0
MEM_WP
Text GLabel 5850 3150 2    45   Input ~ 0
MEM_MISO
Text GLabel 5850 3250 2    45   Output ~ 0
MEM_MOSI
Text GLabel 5650 5200 2    45   Output ~ 0
MEM_MISO
Text GLabel 5650 5050 2    45   Input ~ 0
MEM_MOSI
Text GLabel 5650 5400 2    45   Input ~ 0
MEM_WP
Text GLabel 5650 5550 2    45   Input ~ 0
MEM_HOLD
$Comp
L R R4
U 1 1 5BC4CFF5
...
F 1 "10k" V 3000 4950 45  0000 C CNN
F 2 "pmod-wifi:SMD0603" H 3000 4950 60  0001 C CNN
...
U 1 1 5BC4D1A7
P 3000 4650
F 0 "#PWR026" H 3000 4610 30  0001 C CNN
F 1 "+3.3V" H 3000 4760 30  0000 C CNN
...
U 1 1 5BC4D264
P 3000 5600
F 0 "J1" V 3000 5850 60  0000 C CNN
F 1 "JUMPER" V 3000 5600 25  0000 C CNN
F 2 "pmod-wifi:CONN_2" H 3000 5600 60  0001 C CNN
...
U 1 1 5BC4D385
P 3000 5850
F 0 "#PWR027" H 3000 5850 30  0001 C CNN
...
F 3 "" H 3000 5850 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 3300 5300 2    45   Output ~ 0
BOOT
...
U 1 1 5BC5C79B
P 3950 7000
F 0 "C12" H 4000 7100 50  0000 L CNN
F 1 "100nF" H 4000 6900 50  0000 L CNN
F 2 "pmod-wifi:SMD0603" H 3950 7000 60  0001 C CNN
...
U 1 1 5BC5C7E6
P 3950 7250
F 0 "#PWR031" H 3950 7250 30  0001 C CNN
...
U 1 1 5BC5CD0A
P 3950 6700
F 0 "#PWR032" H 3950 6660 30  0001 C CNN
F 1 "+3.3V" H 3950 6810 30  0000 C CNN
